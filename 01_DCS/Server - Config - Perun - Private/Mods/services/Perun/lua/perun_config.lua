...
Config.TCPTargetPort = 48631																-- (int) [default: 48621] TCP port to send data to
Config.Instance = 2																		    -- (int) [default: 1] Id number of instance (if multiple DCS instances are to run at the same PC)
...
Config.DebugMode = 0																		-- (int) [0 (default),1,2] Value greater than 0 will display Perun information in DCS log file, values: 1 - minimal verbose, 2 - all log information will be logged
Config.MOTD_L1 = "Bienvenue sur le serveur privé de la VEAF !"										-- (string) Message send to players connecting the server - Line 1
Config.MOTD_L2 = "** This is a FRENCH SPEAKING server **"		    -- (string) Message send to players connecting the server - Line 2
